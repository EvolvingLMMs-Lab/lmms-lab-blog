...
---
**Authors:** [Bo Li](https://brianboli.com/) · Yuanhan Zhang · Xiang An · Yin Xie · Kaicheng Yang · Wenkang Zhang · Xiuwei Zhao · Zheng Cheng · Yirui Wang · Songcen Xu · Changrui Chen · Chunsheng Wu · Huajie Tan · Chunyuan Li · Jing Yang · Jie Yu · Xiyao Wang · Bin Qin · Yumeng Wang · Zizhen Yan · Ziyong Feng · [Ziwei Liu](https://liuziwei7.github.io/) · Jiankang Deng · Dong Guo · Renrui Zhang · Feng Li · Hao Zhang · Kaichen Zhang · Peiyuan Zhang · Yanwei Li

<video controls autoplay loop muted playsinline preload="metadata" aria-label="LLaVA-OneVision-1.5">
  <source src="./legacy/images/llava_ov_1_5_images/llava_ov_1_5_megatron_plus_rice_and_qwen.webm" type="video/webm">
</video>
...
<img src="./legacy/images/llava_ov_1_5_images/llava_ov_1_5_performance.avif" alt="LLaVA-OneVision-1.5 Performance" loading="lazy" decoding="async">
...
<img src="./legacy/images/llava_ov_1_5_images/llava_ov_1_5_scaling.avif" alt="LLaVA-OneVision-1.5 Scaling" loading="lazy" decoding="async">
...
<img src="./legacy/images/llava_ov_1_5_images/llava_ov_1_5_sft.avif" alt="LLaVA-OneVision-1.5 Open Framework" loading="lazy" decoding="async">
...
<img src="./legacy/images/llava_ov_1_5_images/llava_ov_1_5_rice_vit.avif" alt="LLaVA-OneVision-1.5 Open Framework" loading="lazy" decoding="async">


### 2) Three‑Stage Learning Pipeline

- Stage‑1: Language–image alignment<br>
...
- Stage‑1.5: Mid‑stage pretraining with high‑quality knowledge<br>
...
- Stage‑2: Visual instruction alignment<br>
...
<img src="./legacy/images/llava_ov_1_5_images/llava_ov_1_5_efficiency.avif" alt="LLaVA-OneVision-1.5 Open Framework" loading="lazy" decoding="async">
...
- [Model Checkpoints](https://huggingface.co/lmms-lab/LLaVA-OneVision-1.5-4B-Instruct)
- [Training Datasets](https://huggingface.co/datasets/lmms-lab/LLaVA-One-Vision-1.5-Mid-Training-85M)
...
We thank the open-source community and all contributors for their valuable feedback and support.
