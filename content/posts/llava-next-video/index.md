...
<figure>
<img src="./legacy/images/llava_video/video_source_page.avif" alt="Video Sources for LLaVA-Video" loading="lazy" decoding="async">
<figcaption>Video sources in the proposed LLaVA-Video-178K. The relationship between 10
video sources we have utilized and other existing video-language datasets.</figcaption>
</figure>
...
<figure>
<img src="./legacy/images/llava_video/llava_video_data_creation_page-0001.avif" alt="LLaVA-Video Data Creation" loading="lazy" decoding="async">
<figcaption>The video detail description creation pipeline. A three-level creation pipeline is considered,
with each level developed via a recurrent approach. Note that t is the index of time internal at its own level,
and T is the last time internal index</figcaption>
</figure>
