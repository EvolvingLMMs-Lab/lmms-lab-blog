...
---
**Authors:** Didi Zhu · Zhiyu Qu · Zerui Chen · Polydefkis Gkagkos · Xiang An · [Bo Li](https://brianboli.com/) · Changrui Chen · Jiankang Deng

<video controls autoplay loop muted playsinline preload="metadata" aria-label="LLaVA-OneVision-1.5-RL">
  <source src="./legacy/images/blog_thumbnails/llava_onevision_1.5_rl.webm" type="video/webm">
</video>


[Technical Report](https://arxiv.org/abs/2509.23661) | [Code](https://github.com/EvolvingLMMs-Lab/-LLaVA-OneVision-1.5-RL) | [Models](https://huggingface.co/mvp-lab/LLAVA-OV-1.5-8B-RL) | [Datasets](https://huggingface.co/datasets/mvp-lab/LLaVA-OneVision-1.5-RL-Data) | [Base Model](https://github.com/EvolvingLMMs-Lab/LLaVA-OneVision-1.5)
...
<figure>
<img src="./legacy/images/llava_onevision_1.5_rl_images/rl_extend_performance.avif" alt="Extended Performance Comparison" loading="lazy" decoding="async">
<figcaption>Performance comparison of LLaVA-OV-1.5 and corresponding RL version on Spatial Reasoning &amp; Grounding and Coding tasks</figcaption>
</figure>
...
- [Research Paper](https://arxiv.org/abs/2509.23661)
- [Training Code](https://github.com/EvolvingLMMs-Lab/-LLaVA-OneVision-1.5-RL)
- [Model Checkpoints](https://huggingface.co/mvp-lab/LLAVA-OV-1.5-8B-RL)
- [Training Datasets](https://huggingface.co/datasets/mvp-lab/LLaVA-OneVision-1.5-RL-Data)
- [Base Model](https://github.com/EvolvingLMMs-Lab/LLaVA-OneVision-1.5)
