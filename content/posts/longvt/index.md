...
---
**Authors:** Zuhao Yang · Sudong Wang · Kaichen Zhang · Keming Wu · Sicong Leng · Yifan Zhang · [Bo Li](https://brianboli.com/) · Chengwei Qin · Shijian Lu · Xingxuan Li · Lidong Bing
...
**(1) LongVT: An End-to-End Agentic Framework for "Thinking with Long Videos"**<br>
...
**(2) VideoSIAH: A Fine-Grained Data Suite for Evidence-Sparse Long-Video Reasoning**<br>
...
**(3) LongVT-7B-RFT: A State-of-the-Art Baseline with Invaluable Insights**<br>
...
<img src="./legacy/images/longvt_images/teaser.avif" alt="LongVT Interleaved Multimodal Chain-of-Tool-Thought" loading="lazy" decoding="async">
...
<img src="./legacy/images/longvt_images/pipeline.avif" alt="VideoSIAH Data Pipeline" loading="lazy" decoding="async">
...
<img src="./legacy/images/longvt_images/video_category.avif" alt="Video Category Distribution" loading="lazy" decoding="async">




<img src="./legacy/images/longvt_images/question_category.avif" alt="Question Category Distribution" loading="lazy" decoding="async">
...
<img src="./legacy/images/longvt_images/ablation.avif" alt="Training Dynamics and Ablations on Reward Design" loading="lazy" decoding="async">
...
- [Code Repository](https://github.com/EvolvingLMMs-Lab/LongVT)
- [Technical Report](https://arxiv.org/abs/2511.20785)
- [Model Checkpoints](https://huggingface.co/longvideotool)
- [Training Datasets](https://huggingface.co/longvideotool)
